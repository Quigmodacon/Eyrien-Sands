...
public:
    ...
    int     capacity      ()                   const; //Max chars that can be stored (not including null termin)
    int     length        ()                   const; //Number of char in string
	String  substr        (int, int)           const; //Returns substring
	int     findch        (int, char)          const; //Returns position of a character in the string
    int     findstr       (int, const String&) const; //Returns position of a substr
